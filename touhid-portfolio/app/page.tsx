  ...
  return (
    <>
      ...
      <section id="skills" className="py-24 px-6 max-w-6xl mx-auto">
        ...
        <div className="rotating-border-card mb-8 p-6 rounded-2xl border border-purple-500/30 hover:border-purple-500/60 transition-all duration-500 hover:scale-[1.02]">
          ...
          <div className="flex flex-wrap gap-3">
            {["LLM Fine-tuning (LoRA)", "RAG (LangChain)", "AI Agents", "Prompt Engineering", "Transformers", "YOLOv11"].map((skill, i) => (
              <span 
                key={i} 
                className="px-3 py-1.5 bg-purple-600/20 text-purple-300 rounded-lg text-sm hover:bg-purple-600/40 transition-all duration-300 hover:scale-105 cursor-pointer"
              >
                {skill}
              </span>
            ))}
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-6">
          {[
            ...
            <div 
              key={idx} 
              className="rotating-border-card glass p-8 rounded-3xl transition-all duration-500 hover:scale-105 hover:-translate-y-2 group"
            >
      ...
      <section id="projects" className="py-24 px-6 max-w-6xl mx-auto">
        ...
        <div className="grid grid-cols-1 md:grid-cols-12 gap-6">
          ...
          <div className="md:col-span-7 rotating-border-card glass p-10 rounded-[2.5rem] group transition-all duration-500 hover:scale-[1.02] hover:-translate-y-2">
            <div className="flex justify-between items-start mb-6">
              <div className="px-4 py-2 bg-purple-600/20 text-purple-400 rounded-xl text-sm font-semibold flex items-center gap-2">
                <span className="text-xl">📚</span>
                LLM / RAG
              </div>
              <div className="w-8 h-8 rounded-full bg-slate-800 flex items-center justify-center group-hover:bg-blue-600 transition-colors duration-300">
            ...
            <div className="flex gap-4">
              <Link href="#" className="text-purple-400 text-sm hover:underline opacity-0 group-hover:opacity-100 transition-all duration-300 translate-y-2 group-hover:translate-y-0">
                🔗 Live Demo →
              </Link>
              <Link href="#" className="text-slate-400 text-sm hover:underline opacity-0 group-hover:opacity-100 transition-all duration-300 translate-y-2 group-hover:translate-y-0">
                📂 GitHub →
              </Link>
            </div>
          </div>

          <div className="md:col-span-5 rotating-border-card glass p-10 rounded-[2.5rem] group transition-all duration-500 hover:scale-[1.02] hover:-translate-y-2">
            <div className="flex justify-between items-start mb-6">
              <div className="px-4 py-2 bg-blue-600/20 text-blue-400 rounded-xl text-sm font-semibold flex items-center gap-2">
                <span className="text-xl">💵</span>
                Computer Vision
              </div>
              <div className="w-8 h-8 rounded-full bg-slate-800 flex items-center justify-center group-hover:bg-blue-600 transition-colors duration-300">
            ...
            <div className="flex gap-4">
              <Link href="#" className="text-blue-400 text-sm hover:underline opacity-0 group-hover:opacity-100 transition-all duration-300 translate-y-2 group-hover:translate-y-0">
                📂 GitHub →
              </Link>
            </div>
          </div>

          <div className="md:col-span-6 rotating-border-card glass p-10 rounded-[2.5rem] group transition-all duration-500 hover:scale-[1.02] hover:-translate-y-2">
            <div className="flex justify-between items-start mb-6">
              <div className="px-4 py-2 bg-green-600/20 text-green-400 rounded-xl text-sm font-semibold flex items-center gap-2">
                <span className="text-xl">🔍</span>
                AI Agent / Automation
              </div>
              <div className="w-8 h-8 rounded-full bg-slate-800 flex items-center justify-center group-hover:bg-blue-600 transition-colors duration-300">
            ...
            <div className="flex gap-4">
              <Link href="#" className="text-green-400 text-sm hover:underline opacity-0 group-hover:opacity-100 transition-all duration-300 translate-y-2 group-hover:translate-y-0">
                🔗 Live Demo →
              </Link>
              <Link href="#" className="text-slate-400 text-sm hover:underline opacity-0 group-hover:opacity-100 transition-all duration-300 translate-y-2 group-hover:translate-y-0">
                📂 GitHub →
          ...
          <div className="md:col-span-6 rotating-border-card glass p-10 rounded-[2.5rem] group transition-all duration-500 hover:scale-[1.02] hover:-translate-y-2">
            <div className="flex justify-between items-start mb-6">
              <div className="px-4 py-2 bg-orange-600/20 text-orange-400 rounded-xl text-sm font-semibold flex items-center gap-2">
                <span className="text-xl">🇧🇩</span>
                Model Tuning
              </div>
              <div className="w-8 h-8 rounded-full bg-slate-800 flex items-center justify-center group-hover:bg-blue-600 transition-colors duration-300">
            ...
            <div className="flex gap-4">
              <Link href="#" className="text-orange-400 text-sm hover:underline opacity-0 group-hover:opacity-100 transition-all duration-300 translate-y-2 group-hover:translate-y-0">
                🤗 Hugging Face →
              </Link>
              <Link href="#" className="text-slate-400 text-sm hover:underline opacity-0 group-hover:opacity-100 transition-all duration-300 translate-y-2 group-hover:translate-y-0">
                📂 GitHub →
      ...
      <section className="py-24 px-6 max-w-6xl mx-auto">
        ...
        <div className="rotating-border-card glass p-10 rounded-[2.5rem] transition-all duration-500 hover:scale-[1.01]">
          ...
          <ul className="space-y-3 text-slate-300">
            <li className="flex gap-3 items-start group/item">
              <span className="text-green-400 mt-1 group-hover/item:scale-125 transition-transform duration-300">🚀</span>
            ...
            <li className="flex gap-3 items-start group/item">
              <span className="text-green-400 mt-1 group-hover/item:scale-125 transition-transform duration-300">🏛️</span>
      ...
      <section className="py-24 px-6 max-w-6xl mx-auto">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          {[
            ...
            <div 
              key={idx} 
              className="rotating-border-card glass p-6 rounded-2xl text-center transition-all duration-500 hover:scale-105 hover:-translate-y-2 cursor-pointer"
            >
      ...
      <footer id="contact" className="py-20 border-t border-slate-900 text-center relative overflow-hidden">
        ...
        <div className="relative z-10">
          ...
          <div className="flex justify-center gap-8 text-slate-400 flex-wrap">
            <Link href="#" className="hover:text-white transition-all duration-300 flex items-center gap-2 hover:scale-110">
              🐙 GitHub
            </Link>
            <Link href="#" className="hover:text-white transition-all duration-300 flex items-center gap-2 hover:scale-110">
              🔗 LinkedIn
            </Link>
            <Link href="mailto:touhid@example.com" className="hover:text-white transition-all duration-300 flex items-center gap-2 hover:scale-110">
              📧 touhid@example.com
            </Link>
            <button 
              onClick={handleDownloadResume}
          ...
          <div className="mt-8 flex justify-center gap-4 text-xs text-slate-600 flex-wrap">
            <span className="flex items-center gap-1">🏆 98% Model Precision</span>
            <span>•</span>
            <span className="flex items-center gap-1">🚀 35-40% Performance Gain</span>
            <span>•</span>
